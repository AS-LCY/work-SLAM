...
//////////////////////////////////// - global_localize - /////////////////////////////////////////
bool GlobalLocalization::global_localize(PointCloudXYZI::Ptr cloud_in, Eigen::Isometry3d pose, Matrix3d initial_rotate, double score_thr){
    /// check map status
    if (!map_ready_) {
