...
public:
    ...
    // PointCloudType::Ptr get_loaded_global_map(){
    ...
    bool global_localize(PointCloudType::Ptr cloudIn, Eigen::Isometry3d pose, Matrix3d initial_rotate, double score_thr);
...
private:
    ...
    /// @return 
    bool scancontex_search(PointCloudType::Ptr cloud_in, Matrix3d initial_rotate, std::pair<int, float> &best_match, std::pair<double, double> &best_trans);
    ...
    bool registration_icp(PointCloudType::Ptr cloud_in, Eigen::Isometry3d pose, Eigen::Matrix4d init_guess, double score_thr, Eigen::Isometry3d& res_global_odom_to_map);
