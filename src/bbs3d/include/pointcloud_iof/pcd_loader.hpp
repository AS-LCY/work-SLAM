...
namespace pciof {
inline bool load_tar_clouds(const std::string& tar_path, const float tar_leaf_size,
...
inline bool load_src_points_with_filename(
	const std::string& src_path, const double min_scan_range, const double max_scan_range, const float src_leaf_size,
