...
public:
    ...
    PoseEKF(const int& status_num, const int& input_num, const int& measure_num,
               const Matrix& status_cov, const Matrix& input_cov, const Matrix& measure_cov,
               const double& dt, const EkfGatingParams& gating_params);
