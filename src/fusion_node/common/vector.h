...
class Vector {
   public:
	...
	static std::vector<double> add(const std::vector<double>& vct1, const std::vector<double>& vct2);

	/// @brief add each element of two geometry_msgs::Vector3
	/// @param vct1 the first vector
	/// @param vct2 the second vector
	/// @return the sum of the two given vectors
	static geometry_msgs::Vector3 add(const geometry_msgs::Vector3& vct1, const geometry_msgs::Vector3& vct2);

	/// @brief add each element of two geometry_msgs::Point
	/// @param pt1 the first point
	/// @param pt2 the second point
	/// @return the sum of the two given points
	static geometry_msgs::Point add(const geometry_msgs::Point& pt1, const geometry_msgs::Point& pt2);

	/// @brief element-wise vector substraction: v = v1 - v2
	/// @param vct1 the first vector
	/// @param vct2 the second vector
	/// @return v1 - v2
	static std::vector<double> sub(const std::vector<double>& vct1, const std::vector<double>& vct2);

	/// @brief element-wise vector substraction: v = v1 - v2
	/// @param vct1 the first vector
	/// @param vct2 the second vector
	/// @return v1 - v2
	static geometry_msgs::Vector3 sub(const geometry_msgs::Vector3& vct1, const geometry_msgs::Vector3& vct2);

	/// @brief add each element of two geometry_msgs::Vector3
	/// @param pt1 the first vector
	/// @param pt2 the second vector
	/// @return the sum of the two given vectors
	static geometry_msgs::Point sub(const geometry_msgs::Point& pt1, const geometry_msgs::Point& pt2);
	...
	static std::vector<double> scale(const std::vector<double>& vct, const double& scaler);

	/// @brief element-wise vector scaling
	/// @param vct the imput vector
	/// @param scaler the scaler multiplier
	/// @return the scaled vector
	static geometry_msgs::Vector3 scale(const geometry_msgs::Vector3& vct, const double& scaler);

	/// @brief element-wise vector devide
	/// @param pt the imput vector
	/// @param scaler the scaler multiplier
	/// @return the scaled vector
	static geometry_msgs::Point scale(const geometry_msgs::Point& pt, const double& scaler);
	...
	static double dot(const std::vector<double>& vct1, const std::vector<double>& vct2);
	...
	/// @return the dot product of the two given vectors
	static double dot(const geometry_msgs::Vector3& vct1, const geometry_msgs::Vector3& vct2, bool use_2D = false);
	...
	static double dot(const geometry_msgs::Point& pt1, const geometry_msgs::Point& pt2, bool use_2D = false);
	...
	static geometry_msgs::Vector3 cross(const geometry_msgs::Vector3& vct1, const geometry_msgs::Vector3& vct2);
	...
	static double cross(const geometry_msgs::Vector3& vct1, const geometry_msgs::Vector3& vct2, bool use_2D);

	/// @brief calculates cross product of two geometry_msgs::Point
	/// @param pt1 the first point
	/// @param pt2 the second point
	/// @return the cross product (vector) of the two given points
	static geometry_msgs::Point cross(const geometry_msgs::Point& pt1, const geometry_msgs::Point& pt2);
	...
	static double cross(const geometry_msgs::Point& pt1, const geometry_msgs::Point& pt2, bool use_2D);
	...
	static double distance(const geometry_msgs::Vector3& vct1, const geometry_msgs::Vector3& vct2, bool use_2D = false);
	...
	/// @param use_2D the marker to indicate using 2D distance
	/// @return the distance between this two points
	static double distance(const geometry_msgs::Point& pt1, const geometry_msgs::Point& pt2, bool use_2D = false);
	...
	/// @param pt2 the second vector
	/// @return true if two vectors are identical
	static bool identical(const geometry_msgs::Point& pt1, const geometry_msgs::Point& pt2);
