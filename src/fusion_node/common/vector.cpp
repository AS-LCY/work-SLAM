...
std::vector<double> Vector::add(const std::vector<double>& vct1,
    ...
    for (it1 = vct1.begin(), it2 = vct2.begin();
         it1 != vct1.end() && it2 != vct2.end();
         ++it1, ++it2) {
...
geometry_msgs::Vector3 Vector::add(const geometry_msgs::Vector3& vct1,
...
geometry_msgs::Point Vector::add(const geometry_msgs::Point& pt1,
...
std::vector<double> Vector::sub(const std::vector<double>& vct1,
                                const std::vector<double>& vct2) {
    std::vector<double> result;
    if (vct1.size() != vct2.size()) {
...
geometry_msgs::Vector3 Vector::sub(const geometry_msgs::Vector3& vct1,
                                   const geometry_msgs::Vector3& vct2) {
    geometry_msgs::Vector3 result;
    result.x = vct1.x - vct2.x;
    result.y = vct1.y - vct2.y;
...
geometry_msgs::Point Vector::sub(const geometry_msgs::Point& pt1,
                                 const geometry_msgs::Point& pt2) {
    geometry_msgs::Point result;
    result.x = pt1.x - pt2.x;
    result.y = pt1.y - pt2.y;
...
std::vector<double> Vector::scale(const std::vector<double>& vct,
                                  const double& scaler) {
    std::vector<double> result;
...
geometry_msgs::Vector3 Vector::scale(const geometry_msgs::Vector3& vct,
                                     const double& scaler) {
    geometry_msgs::Vector3 result;
...
geometry_msgs::Point Vector::scale(const geometry_msgs::Point& pt,
                                   const double& scaler) {
    geometry_msgs::Point result;
...
double Vector::dot(const std::vector<double>& vct1,
                   const std::vector<double>& vct2) {
    if (vct1.size() != vct2.size()) {
...
double Vector::dot(const geometry_msgs::Vector3& vct1,
                   const geometry_msgs::Vector3& vct2,
                   bool use_2D) {
    if (use_2D) {
...
double Vector::dot(const geometry_msgs::Point& pt1,
                   const geometry_msgs::Point& pt2,
                   bool use_2D) {
...
double Vector::norm2(const std::vector<double>& vct) {
    return sqrt(dot(vct, vct));
};

double Vector::norm2(const geometry_msgs::Vector3& vct3, bool use_2D) {
    return sqrt(dot(vct3, vct3, use_2D));
};

double Vector::norm2(const geometry_msgs::Point& pt, bool use_2D) {
    return sqrt(dot(pt, pt, use_2D));
};
...
geometry_msgs::Vector3 Vector::cross(const geometry_msgs::Vector3& vct1,
                                     const geometry_msgs::Vector3& vct2) {
    geometry_msgs::Vector3 result;
...
double Vector::cross(const geometry_msgs::Vector3& vct1,
                     const geometry_msgs::Vector3& vct2,
                     bool use_2D) {
    return vct1.x * vct2.y - vct1.y * vct2.x;
};

geometry_msgs::Point Vector::cross(const geometry_msgs::Point& pt1,
                                   const geometry_msgs::Point& pt2) {
    return toggle_type(cross(toggle_type(pt1), toggle_type(pt2)));
};

double Vector::cross(const geometry_msgs::Point& pt1,
                     const geometry_msgs::Point& pt2,
                     bool use_2D) {
...
///                   OTHER - OPERATIONS                 ///
////////////////////////////////////////////////////////////
double Vector::distance(const geometry_msgs::Vector3& vct1,
                        const geometry_msgs::Vector3& vct2,
                        bool use_2D) {
    return norm2(sub(vct1, vct2), use_2D);
};

double Vector::distance(const geometry_msgs::Point& pt1,
                        const geometry_msgs::Point& pt2,
                        bool use_2D) {
...
bool Vector::identical(const std::vector<double> & v1, const std::vector<double> & v2) {
    ...
    for (itr1 = v1.begin(), itr2 = v2.begin();
         itr1 != v1.end() && itr2 != v2.end();
         ++itr1, ++itr2) {
...
bool Vector::identical(const geometry_msgs::Point& pt1,
        const geometry_msgs::Point& pt2) {
    if (fabs(pt1.x - pt2.x) > 1e-9
            || fabs(pt1.y - pt2.y) > 1e-9
            || fabs(pt1.z - pt2.z) > 1e-9) {
        return false;
    }
    return true;
}
