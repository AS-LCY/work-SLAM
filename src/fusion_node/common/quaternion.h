...
/// @brief The Quaternion Class includes most of the commonly used quaternion operations, and convertion between Euler Angle and Quaternions.
class Quaternion {
public:
...
/// @brief The static method rotate_vector3 rotates the input vector with the rotation decribed by the input quaterion.
/// @param vin with type [geometry_msgs::Vector3](http://docs.ros.org/api/geometry_msgs/html/msg/Vector3.html) is the input vector to be rotated.
/// @param quat with type [geometry_msgs::Quaternion](http://docs.ros.org/api/geometry_msgs/html/msg/Quaternion.html) is the rotation described in quaternion.
...
/// @brief The static method get_euler_zyx convers a rotation from quaternion form to euler form with the order z-y-x (or yaw-pitch-roll)
/// @param quat with type [geometry_msgs::Quaternion](http://docs.ros.org/api/geometry_msgs/html/msg/Quaternion.html) is the rotation in quaternion form
...
/// @return the quaternion that can rotate vector v1 to vector v2
    static geometry_msgs::Quaternion get_quaternion(const geometry_msgs::Vector3& v1,
...
/// @return The function returns a quaternion that describes the rotation equivalent to executing the two rotions one after the other
    static geometry_msgs::Quaternion multiply(const geometry_msgs::Quaternion& q1,
