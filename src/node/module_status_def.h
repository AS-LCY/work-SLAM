...
static string print_ModuleStatus(ModuleStatus e) {
	switch (e) {
		case ModuleStatus::MODULE_IDLE:
			return "IDLE";
		case ModuleStatus::MODULE_MAPPING:
			return "MAPPING";
		case ModuleStatus::MODULE_SEC_MAPPING:
			return "SEC_MAPPING";
		case ModuleStatus::MODULE_LOCALIZATION:
			return "LOCALIZATION";
		case ModuleStatus::MODULE_STARTING_SLAM:
			return "STARTING_SLAM";
		case ModuleStatus::MODULE_STOPPING_SLAM:
			return "STOPPING_SLAM";
		default:
			break;
	}
