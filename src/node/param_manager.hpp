   ...
   public:
	...
	bool load_config_params() {
		...
		node_->get_parameter("re_localization.local_reg.correspondences_number",
							 loaded_param_.re_localization.relocalize_config.gicp_config_.correspondence_randomness_);
		...
		node_->get_parameter("re_localization.local_reg.overlap_threshold",
							 loaded_param_.re_localization.relocalize_config.gicp_config_.overlap_threshold_);
