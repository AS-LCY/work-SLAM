...
LidarPreprocM300::LidarPreprocM300(rclcpp::Node::SharedPtr node): LidarPreprocParent(node){
    if(!set_param(node)){
...
LidarPreprocM300::~LidarPreprocM300(){

}



bool LidarPreprocM300::pre_process(const sensor_msgs::msg::PointCloud2::SharedPtr ros_msg_in, PointCloudType::Ptr& pcl_xyzin_out){
...
// current used
bool LidarPreprocM300::msg2pcl_clip(const sensor_msgs::msg::PointCloud2::SharedPtr ros_msg_in, PointCloudType::Ptr pcl_xyzin_out){
...
bool LidarPreprocM300::set_param(rclcpp::Node::SharedPtr node){
...
///////////////// 入口函数 /////////////////                  
// bool LidarPreprocM300::pre_process(const pcl::PointCloud<BsPointXYZI>::Ptr pcl_rs_in, PointCloudType::Ptr pcl_xyzin_out){
...
// //////////////////////////////////////////////////////////////////////////////////////////////////
// // 间隔采样
// void LidarPreprocM300::extract_cloud_by_interval_sampling(const pcl::PointCloud<BsPointXYZI>::Ptr pcl_rs_in, PointCloudType::Ptr pcl_xyzin_out){
