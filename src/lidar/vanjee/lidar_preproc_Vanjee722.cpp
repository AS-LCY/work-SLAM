...
bool LidarPreprocVanjee722::pre_process(const sensor_msgs::msg::PointCloud2::SharedPtr ros_msg_in,
...
// current used
bool LidarPreprocVanjee722::msg2pcl_clip(const sensor_msgs::msg::PointCloud2::SharedPtr ros_msg_in,
										 PointCloudType::Ptr pcl_xyzin_out) {
...
// ///////////////// 入口函数 /////////////////
// bool LidarPreprocVanjee722::pre_process(const pcl::PointCloud<RsPointXYZIRT>::Ptr pcl_rs_in, PointCloudType::Ptr
// pcl_xyzin_out){
...
// //////////////////////////////////////////////////////////////////////////////////////////////////
// // 间隔采样
// void LidarPreprocVanjee722::extract_cloud_by_interval_sampling(const pcl::PointCloud<RsPointXYZIRT>::Ptr pcl_rs_in,
// PointCloudType::Ptr pcl_xyzin_out){
