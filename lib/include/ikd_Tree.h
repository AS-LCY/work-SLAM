...
public:
    ...
    void set_cube_len(float cube_len)
    {
        cube_len = cube_len;
    }
    void set_det_range(float det_range)
    {
        det_range = det_range;
    }
    ...
    void map_incremental(PointTypeCloud feats_down_body,const vector<PointVector>& Nearest_Points,bool flg_EKF_inited);//zx add
};
